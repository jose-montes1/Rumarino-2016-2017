...
/*\****************************************************************
 *Function Description
 *      Stops the current timer, waits the current value
 *      modified by a scaling factor and returns to the previous wait
 *Parameters
 *      int scaling_factor - the value the function is multiplied
